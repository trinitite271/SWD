%
function [deta_cc22,deta_c,ml]=RTpl(seismo_v1,is,df,dt,np,vmin,vmax,fmin,fmax,a,b,cr_0,ds,offset,m,FK,M,fre,ind,npair,win)
%#######################################################################!
%!
...
deta_00=fre'.*(-deta_c)./((cr_1).*(cr_01));
  deta_cc22(ind:ind+npair-1)=deta_00;
return
